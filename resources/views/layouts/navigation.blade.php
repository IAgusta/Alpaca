<nav x-data="{ open: false, pluginsOpen: false, loading: false }" class="bg-white dark:bg-gray-800 dark:border-slate-500 border-b border-gray-100 fixed top-0 left-0 w-full z-30">
    <!-- Loading Bar -->
