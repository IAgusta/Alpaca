<!-- Side Drawer Navigation -->
    <div :class="{'translate-x-0': open, '-translate-x-full': !open}" 
        class="fixed top-0 left-0 h-full w-64 bg-white dark:bg-gray-800 shadow-lg transform transition-transform duration-300 ease-in-out lg:hidden flex flex-col">
        ...
        <div class="border-t border-gray-200 dark:border-gray-700 px-4 py-2 space-y-2">
            ...
            <!-- Social Media -->
            <div class="mt-2">
                <h2 class="mb-2 text-xs font-semibold text-gray-900 uppercase dark:text-white">Our Social Media</h2>
