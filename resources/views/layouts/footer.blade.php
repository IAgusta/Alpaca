<footer class="w-full bg-white border-t border-gray-200 shadow-sm dark:bg-black dark:border-gray-800">
    <div class="px-4 py-3">
        <div class="flex items-center justify-center">
            <span class="text-sm text-gray-500 dark:text-gray-400">© 2025 <a href="{{ route('home') }}" class="hover:underline">Alpaca™</a>. All Rights Reserved.</span>
        </div>
        <div class="flex flex-col md:flex-row justify-center items-center w-full mt-3 gap-2 lg:gap-8">
            ...
            <div class="flex space-x-5 rtl:space-x-reverse">
                <a href="mailto:ikraamagusta91@gmail.com" class="text-gray-400 hover:text-gray-900 dark:hover:text-white">
                  ...
                  <span class="sr-only">Gmail page</span>
                </a>
