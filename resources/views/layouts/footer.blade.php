<footer class="relative bottom-0 left-0 z-0 w-full p-4 bg-white border-t border-gray-200 shadow-sm md:flex md:flex-col md:items-center justify-center md:p-6 dark:bg-black dark:border-gray-800">
