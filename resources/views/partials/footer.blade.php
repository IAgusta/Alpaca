    ...
    <div class="row">
      <div class="col-6 col-md-2 mb-3">
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item mb-2"><a href="/price" class="nav-link p-0 text-body-secondary">Pricing</a></li>
      ...
      <div class="col-6 col-md-2 mb-3">
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item mb-2"><a href="https://wa.me/6282171639538" class="nav-link p-0 text-body-secondary">Customer Service</a></li>
        </ul>
      </div>
      ...
      <div class="col-6 col-md-2 mb-3">
        <h5>Plugins</h5>
        <ul class="nav flex-column">
          <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Controller</a></li>
          <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Parenting</a></li>
        </ul>
      </div>

      <div class="col-md-5 offset-md-1 mb-3">
        <form>
          <h5>Berlangganan dengan Alpaca</h5>
          <p>Dapatkan Berita terupdate tentang kami.</p>
